    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            ...
            try (OutputStream out = resp.getOutputStream()) {
                ...
                String tituloTexto = "HISTORIAL DE VENTAS";
                ...
                addHeaderCell(table, "ID Venta", headerFont, headerColor);
                addHeaderCell(table, "Cajero", headerFont, headerColor);
                ...
                for (Map<String, Object> r : lista) {
                    table.addCell(new PdfPCell(new Phrase(String.valueOf(r.get("idventas")), bodyFont)));
                    table.addCell(new PdfPCell(new Phrase(String.valueOf(r.get("cajero")), bodyFont)));
                    ...
                    table.addCell(new PdfPCell(
                            new Phrase(String.format("$%.2f", ((Number) r.get("total")).doubleValue()), bodyFont)));
                ...
                Paragraph totalP = new Paragraph("\nTotal vendido: $" + String.format("%.2f", totalSum), boldFont);
